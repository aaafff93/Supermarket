...
{
    public partial class CashRegisterForm2 : Form
    {
        string decodeBarcode = null;
        public CashRegisterForm2()
        {
            InitializeComponent();
        }

        private void CashRegisterForm2_Load(object sender, EventArgs e)
        {
        ...
        private void MakePurchaseButton_Click(object sender, EventArgs e)
        {
            ...
            {               
                try
                {
                    ...
                    decimal cashRegisterRevenue = decimal.Parse(Connection.dataSet.Tables["CashRegister"].Select($"CashRegisterID = 2")[0]["Revenue"].ToString()); //и тут
                    cashRegisterRevenue = decimal.Add(cashRegisterRevenue, currentRevenue);
                    Connection.dataSet.Tables["CashRegister"].Select($"CashRegisterID = 2")[0]["Revenue"] = cashRegisterRevenue; //и тут
