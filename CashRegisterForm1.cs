...
{
    public partial class CashRegisterForm1 : Form
    {
        string decodeBarcode = null;
        public CashRegisterForm1()
        {
            InitializeComponent();
        }

        private void CashRegisterForm1_Load(object sender, EventArgs e)
        {
        ...
        private void MakePurchaseButton_Click(object sender, EventArgs e)
        {
            ...
            if (storageQuantity >= Int32.Parse(numericUpDown1.Value.ToString()) && pictureBoxImage.Image != null)
            {
                ...
                try
                {
                    ...
                    decimal cashRegisterRevenue = decimal.Parse(Connection.dataSet.Tables["CashRegister"].Select($"CashRegisterID = 1")[0]["Revenue"].ToString());
                    cashRegisterRevenue = decimal.Add(cashRegisterRevenue, currentRevenue);
                    Connection.dataSet.Tables["CashRegister"].Select($"CashRegisterID = 1")[0]["Revenue"] = cashRegisterRevenue;
